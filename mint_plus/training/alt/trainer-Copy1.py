...
from mint_plus.training.wrapper import ESMWrapper
...
class MINTTrainer:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.model = torch.compile(self.model, mode='default')#'reduce-overhead')
    ...
    def _build_trainer(self):
        ...
        trainer = pl.Trainer(
            ...
            gradient_clip_val=self.training_config.get("grad_clip", 1.0),
    ...
    def _build_model(self):
        ...
        self.try_opt = self.model_config.get("try_opt", False)  # try architectural optimizations
        ...
        model = ESM2.from_config(self.model_size, use_multimer=self.use_multimer, try_opt=self.try_opt, layer_spec=self.layer_spec, try_flex=self.try_flex)
    ...
    def fit(self):
        ...
        logger.info(f"  Freeze self-attn: {self.model_config.get('freeze_self_attn', False)}")
